...
const Modal = ({ data }) => {
  return (
    <dialog className="modal fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl w-full max-w-[600px] text-xl bg-light dark:bg-dark dark:text-light">
